...
//! Measured constants (ε₀, μ₀) are provided with 12-13 significant figures from
//! CODATA 2022 with relative uncertainty ~10⁻¹⁰.
//!
//! ## References
//!
//! Physical constants follow CODATA 2022 recommended values:
...
//! - Updated to CODATA 2022 revision available at NIST website

use std::f64::consts::PI;

/// Vacuum permittivity ε₀ in farads per meter (F/m).
/// CODATA 2022 value: 8.8541878188 × 10⁻¹² F/m with relative uncertainty 1.6 × 10⁻¹⁰.
pub const VACUUM_PERMITTIVITY: f64 = 8.854_187_818_8e-12;
/// Vacuum permeability μ₀ in henries per meter (H/m).
/// CODATA 2022 value: 1.25663706127 × 10⁻⁶ H/m with relative uncertainty 1.6 × 10⁻¹⁰.
...
/// Derived from Z₀ = √(μ₀/ε₀) using CODATA 2022 values: 376.730313412 Ω.
